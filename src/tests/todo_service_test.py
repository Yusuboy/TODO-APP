...
class Test_todo_service(unittest.TestCase):
    ...
    def test_create_user(self):
        user = self.todo.create_user("John", "password")
    ...
    def test_get_users_done_tasks(self):
        ...
        user = self.todo.create_user("John", "password")
        self.todo.add_task_to_user("John", "Task 1")
        done_tasks = self.todo.get_users_done_tasks("John")
    ...
    def test_get_users_undone_tasks(self):
        ...
        user = self.todo.create_user("John", "password")
        self.todo.add_task_to_user("John", "Task 1")
        undone_tasks = self.todo.get_users_undone_tasks("John")
